...
** This module is the successor to azure-cache-for-redis.bicep and provides the same
** interface for seamless migration via feature flag.
*/
...
@description('Specify the pricing tier of the new Azure Managed Redis. Maps to equivalent Azure Cache for Redis SKUs.')
@allowed([
  'Basic'
  'Standard'
  'Premium'
...
@description('Specify the size of the new Azure Managed Redis instance. Valid values: for C (Basic/Standard) family (0, 1, 2, 3, 4, 5, 6), for P (Premium) family (1, 2, 3, 4)')
@allowed([
  0
  1
  2
...
resource cache 'Microsoft.Cache/redis@2024-03-01' = {
  ...
  properties: {
    ...
    publicNetworkAccess: privateEndpointSettings != null ? 'Disabled' : 'Enabled'
  }
}

@batchSize(1)
resource redisCacheBuiltInAccessPolicyAssignment 'Microsoft.Cache/redis/accessPolicyAssignments@2024-03-01' = [for user in users: {
