...
resource keyVaultRoleAssignmentForWebApp 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  ...
  properties: {
    ...
    description: 'Grant the "Key Secrets User" role to the user managed identity so it can read from the key vault service.'
  }
}
...
var subnetPowerAppsGateway = 'subnetPowerAppsGateway'
...
resource vnet 'Microsoft.Network/virtualNetworks@2020-07-01' = {
  ...
  resource powerAppsGatewaySubnet 'subnets' existing = {
    name: subnetPowerAppsGateway
  }
}
...
resource pvtEndpointDnsGroupNameForSql 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2020-07-01' = {
  parent: privateEndpointForSql
  name: 'mydnsgroupname'
  properties: {
